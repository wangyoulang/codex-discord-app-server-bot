...
def main() -> None:
    ...
    result = {
        ...
        "codex_http_proxy_configured": bool(settings.codex_http_proxy),
        "codex_https_proxy_configured": bool(settings.codex_https_proxy),
        "codex_all_proxy_configured": bool(settings.codex_all_proxy),
        "codex_no_proxy_configured": bool(settings.codex_no_proxy),
